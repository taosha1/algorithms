...
//            System.out.print(numbers[left][i]);
//        }
//        for (int i = right-1; i < boom; i++) {
//            System.out.print(numbers[i][rightUp[1]]);
//        }
//        // <-
//        for (int i = rightDown[0]; i > leftDown[0]; i--) {
//            System.out.print(numbers[rightDown[0]][i]);
//        }
//        for (int i = leftDown[1]; i > leftUp[1]; i--) {
